...
This page provides the associated class IDs for PeekingDuck's models.


.. glossary::

    keypoint indices
        This table provides the associated indices for each keypoint for Pose Estimation models

        +-------------+---------------+-------------+----------------+-------------+---------------+-------------+---------------+
        | Keypoint ID | Keypoint      | Keypoint ID | Keypoint       | Keypoint ID | Keypoint      | Keypoint ID | Keypoint      |
        +=============+===============+=============+================+=============+===============+=============+===============+
    ...
    object detection indices
        ...
        +---------------+---------------------+-----------------------+----------------+---------------------+-----------------------+
        | Class name    | YOLO/YOLOX Class ID | EfficientDet Class ID | Class name     | YOLO/YOLOX Class ID | EfficientDet Class ID |
        +===============+=====================+=======================+================+=====================+=======================+
