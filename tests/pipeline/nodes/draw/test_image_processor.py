...
def draw_image_processor():
    node = Node({"input": ["img"], "output": ["img"], "brightness": 0, "contrast": 1})
    return node


@pytest.fixture
def draw_image_processor_brighter():
    node = Node({"input": ["img"], "output": ["img"], "brightness": 20, "contrast": 1})
    return node


@pytest.fixture
def draw_image_processor_contrast():
    node = Node({"input": ["img"], "output": ["img"], "brightness": 0, "contrast": 2})
    return node
