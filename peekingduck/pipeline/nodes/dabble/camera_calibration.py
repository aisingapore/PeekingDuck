...
def get_box_info(num, width, height):
...
def draw_text(img: np.ndarray, text: str, pos_info: tuple) -> None:
...
def check_corners_valid(width, height, corners, start_point, end_point):
...
class Node(AbstractNode):
    ...
    def detect_corners(self, height, width, gray_img):
    ...
    def calculate_coeffs(self, img_shape):
