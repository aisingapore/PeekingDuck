...
- Docstrings and comments
  ...
  - Example of a class docstring including Read the Docs info: [yolo.py](https://github.com/aisingapore/PeekingDuck/blob/main/peekingduck/nodes/model/yolo.py)
  - Example of a function/method docstring: [transforms.py](https://github.com/aimakerspace/PeekingDuck/blob/main/peekingduck/utils/bbox/transforms.py)
- Type Hints
